"""
Django settings for samdec21_3 project.
...
WSGI_APPLICATION = 'samdec21_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samdec21_3 API",
    "DESCRIPTION": "API documentation for samdec21_3 App",
    "VERSION": "v1",
}
